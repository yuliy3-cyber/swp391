...
public class CreateDiscounts extends HttpServlet {
    ...
    int discountAmounts = Integer.parseInt(amounts);

    Discount discount = new Discount(name, discountValue, discountAmounts);

    adb.createDiscount(discount);

    RequestDispatcher dispatcher = request.getRequestDispatcher("Discounts.jsp");
